...
/**
 * A single checklist item requested by Performance. These are reference material
 * used when building the Master Probationary Checklist — they are never attached
 * to one hire. `position` is "all" when it applies to every job position.
 */
...
/** Pre-onboarding requirements checklist a hire starts with. */
